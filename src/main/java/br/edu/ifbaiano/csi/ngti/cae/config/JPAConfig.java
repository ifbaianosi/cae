...
@EnableJpaRepositories(basePackageClasses = Alunos.class, enableDefaultTransactions=false) //repositorio de cervejas
...
public class JPAConfig {
	...
	public DataSource dataSource() {
		...
		return dataSourceLookup.getDataSource("jdbc/caeDB");
	}
	...
	public JpaVendorAdapter jpaVendorAdapter() {
		...
		adapter.setGenerateDdl(false); // quem irá gerar as tabelas será o Flyway
